...
def _csv():
    ...
    if lstbox.get(0) == '':
        ...
        csvFile = open((day+news1.get()+news2.get()+".csv"), 'w', newline='', encoding='utf-8-sig')
...
def _savefile():
    if lstbox.get(0) == '':
        ...
        file = filedialog.asksaveasfile(initialdir=r'C:\Users\ASUS\OneDrive\Desktop\Vivian',
                                        defaultextension='.*',
                                        filetypes=[
                                            ("All files", ".*"),
                                            ("JSON file", ".json"),
...
n1 = tk.Radiobutton(frm1, text='TVBS新聞', variable=news1, value='TVBS', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=10, y=55)
n2 = tk.Radiobutton(frm1, text='蘋果新聞', variable=news1, value='蘋果', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=140, y=55)
n3 = tk.Radiobutton(frm1, text='中時新聞', variable=news1, value='中時', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=270, y=55)
n4 = tk.Radiobutton(frm1, text='自由時報', variable=news1, value='自由', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=10, y=155)
n5 = tk.Radiobutton(frm1, text='聯合新聞', variable=news1, value='聯合', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=140, y=155)
n6 = tk.Radiobutton(frm1, text='世界新聞', variable=news1, value='世界', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=270, y=155)
...
n7 = tk.Radiobutton(frm2, text='即時', variable=news2, value='即時新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=20, y=55)
n8 = tk.Radiobutton(frm2, text='熱門', variable=news2, value='熱門新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=150, y=55)
n9 = tk.Radiobutton(frm2, text='政治', variable=news2, value='政治新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=280, y=55)
n10 = tk.Radiobutton(frm2, text='健康', variable=news2, value='健康新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=20, y=155)
n11 = tk.Radiobutton(frm2, text='娛樂', variable=news2, value='娛樂新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=150, y=155)
n12 = tk.Radiobutton(frm2, text='全球', variable=news2, value='全球新聞', bg='SkyBlue3', font=('標楷體',16), command=_selectNews).place(x=280, y=155)
